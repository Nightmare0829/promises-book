...
var _prh2 = _interopRequireDefault(_prh);
...
function createPrhEngine(rulePaths, baseDir) {
    ...
    var prhEngine = _prh2.default.fromYAMLFilePath(_path2.default.resolve(baseDir, expandedRulePaths[0]));
    expandedRulePaths.slice(1).forEach(function (ruleFilePath) {
        var config = _prh2.default.fromYAMLFilePath(_path2.default.resolve(baseDir, ruleFilePath));
...
function createPrhEngineFromContents(yamlContents) {
    ...
    var prhEngine = _prh2.default.fromYAML(null, yamlContents[0]);
    yamlContents.slice(1).forEach(function (content) {
        var config = _prh2.default.fromYAML(null, content);
        prhEngine.merge(config);
    });
    return prhEngine;
}
...
function reporter(context) {
    ...
    // .textlinrc directory
    var textlintRCDir = textlintRcFilePath ? _path2.default.dirname(textlintRcFilePath) : process.cwd();
    // create prh config
