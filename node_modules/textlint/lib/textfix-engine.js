...
var _textfixFormatter = require("./fixer/textfix-formatter");

var _textfixFormatter2 = _interopRequireDefault(_textfixFormatter);
...
function TextFixEngine(config) {
    ...
    var executor = {
        ...
        onFormat: function onFormat(formatterConfig) {
            ...
            return (0, _textfixFormatter2.default)(formatterConfig);
        }
    };
